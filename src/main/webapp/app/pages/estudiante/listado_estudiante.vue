          ...
          <tbody>
            <tr v-for="proyecto in proyects" :key="proyecto.id">
              ...
              <td class="text-right">
                ...
                <!-- Pasantías (Tecnologica, Investigativa, Internacional) -->
                <div class="btn-group" v-if="proyecto.proyectoModalidadModalidad && proyecto.proyectoModalidadModalidad.includes('Pasantia')">
                  <router-link
                ...
                <!-- Publicación de Artículo (flujo propio) -->
                <div class="btn-group" v-if="proyecto.proyectoModalidadModalidad=='Publicacion de Articulo'">
                  <router-link
                ...
                <!-- Diplomado y Especialización: SIN FLUJO -->
              </td>
            </tr>
