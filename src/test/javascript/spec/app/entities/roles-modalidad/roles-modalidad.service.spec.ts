...
describe('Service Tests', () => {
  describe('RolesModalidad Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a RolesModalidad', async () => {
      ...
      it('should not update a RolesModalidad', async () => {
      ...
      it('should not return a list of RolesModalidad', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a RolesModalidad', async () => {
