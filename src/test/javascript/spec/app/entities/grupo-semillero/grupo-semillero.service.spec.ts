...
describe('Service Tests', () => {
  describe('GrupoSemillero Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a GrupoSemillero', async () => {
      ...
      it('should not update a GrupoSemillero', async () => {
      ...
      it('should not return a list of GrupoSemillero', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a GrupoSemillero', async () => {
