...
describe('Service Tests', () => {
  describe('ProyectoRespuestas Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a ProyectoRespuestas', async () => {
      ...
      it('should not update a ProyectoRespuestas', async () => {
      ...
      it('should not return a list of ProyectoRespuestas', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a ProyectoRespuestas', async () => {
