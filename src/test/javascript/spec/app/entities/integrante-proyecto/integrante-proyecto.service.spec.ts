...
describe('Service Tests', () => {
  describe('IntegranteProyecto Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a IntegranteProyecto', async () => {
      ...
      it('should not update a IntegranteProyecto', async () => {
      ...
      it('should not return a list of IntegranteProyecto', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a IntegranteProyecto', async () => {
