...
describe('Service Tests', () => {
  describe('RolMenu Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a RolMenu', async () => {
      ...
      it('should not update a RolMenu', async () => {
      ...
      it('should not return a list of RolMenu', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a RolMenu', async () => {
