...
describe('Service Tests', () => {
  describe('Acuerdo Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Acuerdo', async () => {
      ...
      it('should not update a Acuerdo', async () => {
      ...
      it('should not return a list of Acuerdo', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Acuerdo', async () => {
