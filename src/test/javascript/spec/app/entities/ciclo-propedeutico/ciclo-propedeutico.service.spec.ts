...
describe('Service Tests', () => {
  describe('CicloPropedeutico Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a CicloPropedeutico', async () => {
      ...
      it('should not update a CicloPropedeutico', async () => {
      ...
      it('should not return a list of CicloPropedeutico', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a CicloPropedeutico', async () => {
