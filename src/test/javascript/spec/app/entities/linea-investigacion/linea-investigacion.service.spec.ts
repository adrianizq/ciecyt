...
describe('Service Tests', () => {
  describe('LineaInvestigacion Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a LineaInvestigacion', async () => {
      ...
      it('should not update a LineaInvestigacion', async () => {
      ...
      it('should not return a list of LineaInvestigacion', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a LineaInvestigacion', async () => {
